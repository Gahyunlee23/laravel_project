...
class RoomTypesEdit extends Component
{
    ...
    protected $listeners = [
        ...
        'roomTypesEventSave'=>'roomTypesSave'
    ];
    ...
    public function roomTypesSave()
    {
        ...
        $this->emitUp('coreBenefitsEventSave');
    }
    ...
    {
        $this->room_type[] = collect($this->room_type)->count();
    ...
    public function updated($propertyName): void
    {
        ...
        AddHotelNeedToModify::whereAddHotelId($this->addHotel->id)->whereModel('AddHotelRoomTypeImage')->whereTarget($propertyName)->whereNull('status')->update([
            'status'=>'확인'
        ]);
    }
	/**
	...
	{
		return view('livewire.hotels.entry.room-types-edit');
	}
}
