...
<div x-data="{ payment_method : 'credit-card' }">
                            ...
                            <div class=" lg:w-1/2" x-bind:class="{
                                ...
                                <div class="relative p-2 bg-tm-c-ED h-full">
                                    ...
                                    <div class="px-2">
                                        ...
                                        @if($hotel->options[0]->tour_sub_explanation)
                                            <div class="mt-4 sm:mt-8">
                                                <div class="AppSdGothicNeoR text-tm-c-0D5E49 whitespace-pre-line pb-12 pl-3">
                                                    <span class="font-bold text-base sm:text-xl">꼭 읽어주세요!</span><br>
                                                    <span class="leading-7 text-sm sm:text-base">{!! $hotel->options[0]->tour_sub_explanation !!}</span>
                                                </div>
                                            </div>
                                        @endif
                                    </div>
                    ...
                    <div class="my-4">
                        <form name="orderForm" id="orderForm" method="POST">
                            ...
                            <div class="space-y-6 sm:space-y-8">
                                ...
                                <div
                                    x-data="checkBox_check()">
                                    <div class="space-y-2 sm:space-y-3">
                                        <div class="text-white text-lg sm:text-xl AppSdGothicNeoR font-normal">
                                            개인 정보 동의 여부
                                        </div>

                                        <div class="mt-3 border border-solid border-tm-c-d7d3cf rounded-sm divide-y divide-tm-c-d7d3cf">
                                            <div>
                                                <label>
                                                    <div class="h-full" style="min-height:49px;">
                                                                    ...
                                                                    <div class="flex items-center AppSdGothicNeoR text-lg text-white">
                                                                        <div class="z-40">
                                                                            <img
                                                                                x-show="!all_check"
                                                                                src="https://d2pyzcqibfhr70.cloudfront.net/resource/icons/ic-check-normal.svg"
                                                                                class="mx-3 w-8 sm:w-9 cursor-pointer" alt="" x-on:click="check(!all_check)">
                                                                            <img
                                                                                x-show="all_check" x-cloak
                                                                                src="https://d2pyzcqibfhr70.cloudfront.net/resource/icons/ic-check-selected.svg"
                                                                                class="mx-3 w-8 sm:w-9 cursor-pointer" alt="" x-on:click="check(!all_check)">
                                                                        </div>
                                                                        <div class="flex-1 py-5 cursor-pointer text-base sm:text-lg" x-on:click="check(!all_check)">
                                                                            전체 동의
                                                                        </div>
                                                                    </div>
                                                                </div>
                                            ...
                                            <div>
                                                <div class="h-full" style="min-height:49px; border-color:#d7d3cf;">
                                                        ...
                                                        <div class="w-full inline-flex items-center text-sm">
                                                            <div class="flex-1">
                                                                <div class="flex items-center AppSdGothicNeoR text-lg text-white">
                                                                    <div class="z-50">
                                                                        <img
                                                                            x-show="!operating_terms_check"
                                                                            x-on:click="operating_terms_check = !operating_terms_check;adv_box($('.adv_box[data-index=0]'));"
                                                                            src="https://d2pyzcqibfhr70.cloudfront.net/resource/icons/ic-check-normal.svg"
                                                                            class="mx-3 w-8 sm:w-9 cursor-pointer" alt="">
                                                                        <img
                                                                            x-show="operating_terms_check"
                                                                            x-cloak x-on:click="operating_terms_check = !operating_terms_check;adv_box($('.adv_box[data-index=0]'));"
                                                                            src="https://d2pyzcqibfhr70.cloudfront.net/resource/icons/ic-check-selected.svg"
                                                                            class="mx-3 w-8 sm:w-9 cursor-pointer" alt="">
                                                                    </div>
                                                                    <div class="flex-1 py-5 cursor-pointer text-base sm:text-lg"
                                                                         x-on:click="operating_terms_check = !operating_terms_check;operating_terms_show = !operating_terms_show;adv_box($('.adv_box[data-index=0]'));"
                                                                         onclick="slideHeightControl($('.adv_box[data-index=0]'),$('.swiper-slide[data-progress=3]'));">
                                                                        이용약관 및 취소환불 규정 동의 (필수)
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="float-left ml-auto mr-2 cursor-pointer"
                                                                 x-on:click="operating_terms_show = !operating_terms_show;"
                                                                 onclick="slideHeightControl($('.adv_box[data-index=0]'),$('.swiper-slide[data-progress=3]'));">
                                                                <img class="avg_ic2 w-8 h-8" data-index="0"
                                                                     src="https://d2pyzcqibfhr70.cloudfront.net/resource/icons/pc-ic-dropdown.png"
                                                                     x-show="!operating_terms_show"
                                                                     alt="">
                                                                <img class="avg_ic2 w-8 h-8" data-index="0"
                                                                     src="https://d2pyzcqibfhr70.cloudfront.net/resource/icons/pc-ic-dropup.png"
                                                                     x-show="operating_terms_show" x-cloak
                                                                     alt="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div x-show="operating_terms_show" x-cloak
                                                         class="h-42 overflow-y-scroll border-t border-solid border-tm-c-d7d3cf">
                                                        <div class="">
                                                            <div class="py-6 px-2">
                                                ...
                                                <div class="h-full" style="min-height:49px;">
                                                    <div class="adv_box px-2" style="z-index: -1;" data-index="1">
                                                        <div class="w-full inline-flex items-center text-sm">
                                                            <div class="flex-1">
                                                                <label>
                                                                    <div class="flex items-center AppSdGothicNeoR text-lg text-white">
                                                                        <div class="z-40">
                                                                            <img
                                                                                x-show="!privacy_check"
                                                                                src="https://d2pyzcqibfhr70.cloudfront.net/resource/icons/ic-check-normal.svg"
                                                                                class="mx-3 w-8 sm:w-9 cursor-pointer" alt="" x-on:click="privacy_check = !privacy_check;adv_box($('.adv_box[data-index=1]'));">
                                                                            <img
                                                                                x-show="privacy_check" x-cloak
                                                                                src="https://d2pyzcqibfhr70.cloudfront.net/resource/icons/ic-check-selected.svg"
                                                                                class="mx-3 w-8 sm:w-9 cursor-pointer" alt="" x-on:click="privacy_check = !privacy_check;adv_box($('.adv_box[data-index=1]'));">
                                                                        </div>
                                                                        <div class="flex-1 py-5 cursor-pointer text-base sm:text-lg"
                                                                             x-on:click="privacy_show = !privacy_show;privacy_check = !privacy_check;adv_box($('.adv_box[data-index=1]'));"
                                                                             onclick="slideHeightControl($('.adv_box[data-index=1]'),$('.swiper-slide[data-progress=3]'));">
                                                                            개인정보 수집 및 활용 동의 (필수)
                                                                        </div>
                                                                    </div>
                                                                </label>
                                                            ...
                                                            <div class="float-left ml-auto mr-2 cursor-pointer"
                                                                 x-on:click="privacy_show = !privacy_show;"
                                                                 onclick="slideHeightControl($('.adv_box[data-index=1]'),$('.swiper-slide[data-progress=3]'));">
                                                                ...
                                                                <img class="avg_ic2 w-8 h-8" data-index="1"
                                                                     src="https://d2pyzcqibfhr70.cloudfront.net/resource/icons/pc-ic-dropup.png"
                                                                     x-show="privacy_show" x-cloak
                                                                     alt="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div x-show="privacy_show" x-cloak
                                                         class="h-42 overflow-y-scroll border-t border-solid border-tm-c-d7d3cf">
                                                        <div>
                                                            <div class="py-6 px-2">
                                                                <span class="AppSdGothicNeoR text-white text-base leading-7">
                                                ...
                                                <div class="h-full" style="min-height:49px;">
                                                    <div class="adv_box px-2" style="z-index: -1;" data-index="2">
                                                        <div class="w-full inline-flex items-center text-sm">
                                                            <div class="flex-1">
                                                                <label>
                                                                    <div class="flex items-center AppSdGothicNeoR text-lg text-white">
                                                                        <div class="z-40">
                                                                            <img
                                                                                x-show="!marketing_check"
                                                                                src="https://d2pyzcqibfhr70.cloudfront.net/resource/icons/ic-check-normal.svg"
                                                                                class="mx-3 w-8 sm:w-9 cursor-pointer" alt="" x-on:click="marketing_check = !marketing_check;adv_box($('.adv_box[data-index=2]'));">
                                                                            <img
                                                                                x-show="marketing_check" x-cloak
                                                                                src="https://d2pyzcqibfhr70.cloudfront.net/resource/icons/ic-check-selected.svg"
                                                                                class="mx-3 w-8 sm:w-9 cursor-pointer" alt="" x-on:click="marketing_check = !marketing_check;adv_box($('.adv_box[data-index=2]'));">
                                                                        </div>
                                                                        <div class="flex-1 py-5 cursor-pointer text-base sm:text-lg"
                                                                             x-on:click="marketing_show = !marketing_show;marketing_check = !marketing_check;adv_box($('.adv_box[data-index=2]'));"
                                                                             onclick="slideHeightControl($('.adv_box[data-index=2]'),$('.swiper-slide[data-progress=3]'));">
                                                                            마케팅 수신 동의 (선택)
                                                                        </div>
                                                                    </div>
                                                                </label>
                                                            ...
                                                            <div class="float-left ml-auto mr-2 cursor-pointer"
                                                                 x-on:click="marketing_show = !marketing_show;"
                                                                 onclick="slideHeightControl($('.adv_box[data-index=2]'),$('.swiper-slide[data-progress=3]'));">
                                                                <img class="avg_ic2 w-8 h-8" data-index="2"
                                                                     src="https://d2pyzcqibfhr70.cloudfront.net/resource/icons/pc-ic-dropdown.png"
                                                                     x-show="!marketing_show"
                                                                     alt="">
                                                                <img class="avg_ic2 w-8 h-8" data-index="2"
                                                                     src="https://d2pyzcqibfhr70.cloudfront.net/resource/icons/pc-ic-dropup.png"
                                                                     x-show="marketing_show" x-cloak
                                                                     alt="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div x-show="marketing_show" x-cloak
                                                         class="h-42 overflow-y-scroll border-t border-solid border-tm-c-d7d3cf">
                                                        <div>
                                                            <div class="py-6 px-2">
                                                                <span class="AppSdGothicNeoR text-white text-base leading-7">
                                ...
                                {{--<div class="space-y-2 sm:space-y-3">
                                                    ...
                                                    <div class="w-full inline-flex items-center text-sm">
                                                        <div class="flex-1">
                                                            <div class="flex items-center AppSdGothicNeoR text-lg text-white">
                                                                ...
                                                                <div class="flex-1 py-5 cursor-pointer text-base sm:text-lg"
                                                                     onclick="adv_box($('.adv_box[data-index=2]'));slideHeightControl($('.adv_box[data-index=2]'),$('.swiper-slide[data-progress=3]'));">
                                                                    마케팅 수신 동의 (선택)
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="text-sm text-white AppSdGothicNeoR">
                                            * 비회원 결제 시 입력한 정보로 자동 회원가입 처리됩니다.
                                        </div>
                                    </div>--}}
                            </div>
                        </form>
    ...
    <div class="mt-10 sm:flex justify-center space-y-2 sm:space-y-0 sm:space-x-2">
        <div class="w-full h-auto sm:w-2/5 sm:max-w-md prevBtn hidden order-2 sm:order-1">
            <div class="w-full h-full cursor-pointer sm:flex sm:justify-center sm:items-center border-2 border-solid border-tm-c-C1A485 hover:shadow-lg primary-inset-border active:border-tm-c-635749 text-tm-c-C1A485 active:text-tm-c-635749"
                 onclick="prevToSlide()">
        ...
        <div class="hotelChoseBtn w-full sm:w-3/5 sm:max-w-md order-1 sm:order-2 hidden">
            <div class="w-full sm:flex sm:justify-center">
                <div class="w-full bg-tm-c-C1A485 cursor-pointer py-5 sm:py-7 rounded-sm hover:shadow-lg primary-inset-border active:bg-tm-c-897763"
        ...
        <div class="reservationsChoseBtn w-full sm:w-2/5 sm:max-w-md hidden order-1 sm:order-2">
            <div class="w-full sm:flex sm:justify-center">
                <div class="reservationsChoseBtnAction w-full bg-tm-c-C1A485 py-5 sm:py-7 rounded-sm cursor-pointer hover:shadow-lg primary-inset-border active:bg-tm-c-897763"
...
<script>
    ...
    function reservations() {
        ...
        var use_terms = $('.adv_box[data-index=0]').hasClass('on');/*필수 동의*/
        var order_privacy = $('.adv_box[data-index=1]').hasClass('on');/*필수 동의*/
        var order_marketing = $('.adv_box[data-index=2]').hasClass('on');/*선택동의*/
        ...
        if(!use_terms && !order_privacy){
            if(confirm('필수 항목 전체 동의 하시겠습니까?\n항목이 안보이는 경우 다른 기기에서 확인 부탁드립니다.\n필수 동의 항목 - 이용약관 및 취소환불 규정, 개인정보 수집 및 활용 동의')){
                if (!use_terms) {
                    use_terms=true;
                    $('.adv_box[data-index=0]').addClass('on');
                }
                if (!order_privacy) {
                    order_privacy=true;
                    $('.adv_box[data-index=1]').addClass('on');
                }
            }else{
                if (!use_terms) {
                ...
                success: function (data) {
                    if (data.status === 'success') {
                        ...
                        if (data.reservation.type === 'month') {
                            ...
                            var url = '{{ route("reservations.completed", ['reservation'=>":reservation"]) }}';
                            url = url.replace(':reservation', data.reservation.id);
                            location.href = url;
                        }
                    ...
                    success: function (data) {
                        ...
                        for ($i = 0; $i < data.hotel[0].rooms.length; $i++) {
                            ...
                            if(data.hotel[0].rooms[$i].sale_price !== '0'){
                                ...
                                right_bottom_box= '<div class="channelTalk-button mt-1 flex items-center justify-end">' +
                                    '<div class="w-max-content AppSdGothicNeoR text-sm text-white px-5 py-2 bg-tm-c-C1A485 rounded-full cursor-pointer">' +
    ...
    function checkBox_check() {
        return {
            all_check: false,
            operating_terms_show: false,
            operating_terms_check: false,
            privacy_show: false,
            privacy_check: false,
            marketing_show: false,
            marketing_check: false,
            check($bool) {
                if ($bool) {
                    $('.adv_box ').addClass('on');
                    this.all_check = true;
                    this.operating_terms_check = true;
                    this.privacy_check = true;
                    this.marketing_check = true;
                } else {
                    $('.adv_box ').removeClass('on');
                    this.all_check = false;
                    this.operating_terms_check = false;
                    this.privacy_check = false;
                    this.marketing_check = false;
                }
            },
            adv_box($this) {
                if ($this.hasClass('adv_box')) {
                ...
                if($('.adv_box[data-index=0]').hasClass('on')
                    && $('.adv_box[data-index=1]').hasClass('on')
                    && $('.adv_box[data-index=2]').hasClass('on')){
                    this.all_check = true;
                }else{
                    this.all_check = false;
                }
