                                            ...
                                            <tr style="border-collapse:collapse">
                                                <td align="center" valign="top" style="padding:0;Margin:0;width:530px">
                                                    <table cellpadding="0" cellspacing="0" width="100%"
                                                        ...
                                                        <tr style="border-collapse:collapse">
                                                            <td align="left" style="color : #000000; font-size: 14px; padding:5px;Margin:0;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif">
                                                                <span style="font-size: 20px; font-weight: bold;">ㆍ 입점 승인이란? </span> <br><br>

                                                                <span style="font-weight: bold;">입점 승인은 오픈 승인 전 단계로 호텔에삶에 상품이 오픈 될 수 있는 가능성을 내포한 상태</span>입니다.
                                                                입점 승인을 받은 호텔은 <span style="color: #ff0000;">영업일 기준 7일 이내 다음 단계에 대해 메일을 공지</span> 받습니다.<br>
                                                                <span style="font-weight: bold;">'오픈 승인, 수정 요청, 고객 선호도 리스트'</span> 중 1개의 안내를 받으며 오픈을 위한 절차를 진행합니다.<br><br>

                                                                <span style="font-size: 10.5px;">※ 자세한 정보는 아래 파트너사 이용 가이드라인 [보러 가기]를 클릭해 확인해주시기 바랍니다.</span><br><br>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td align="left" style="color: #000000; font-size: 10.5px;padding:5px;Margin:0;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif">
                                                                ※ 입점 신청 시 등록한 가격, 호텔에삶 only 혜택은 <span style="color: #ff0000;">오픈 후 1년 간 수정 불가</span>가 원칙입니다.
                                                                해당 사항 변경을 희망하실 시에는 기존에 상응하거나 더 나은 혜택을 제공했을 시에 가능합니다.<br><br>
                                                            </td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse">
                                                            <td align="left" style="font-size: 14px;padding:5px;Margin:0;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif">

                                                                <span style="font-weight: bold; font-size: 20px;">ㆍ 입점 승인 후 추가 단계 안내</span><br><br>
                                                                1) 오픈 확정 : 입금가 입점 호텔 중 추가 수정 없이 바로 오픈이 가능한 호텔로서 메일을 통해 오픈 진행에 대해 안내 받습니다.<br><br>
                                                                2) 수정 요청 : 오픈 전 추가 수정이 필요할 시 메일을 통해 안내받으며 수정 진행 후 오픈 승인 심사를 받습니다.<br><br>
                                                                3) 고객 선호도 리스트 : 수수료 입점 호텔 중 추가 수정 요청이 없는 호텔로 고객 선호도 리스트에 업로드 되어 결과에 따라 오픈 승인 심사를 받습니다.<br><br>
