                                            ...
                                            <tr style="border-collapse:collapse">
                                                <td align="center" valign="top" style="padding:0;Margin:0;width:530px">
                                                    <table cellpadding="0" cellspacing="0" width="100%"
                                                           ...
                                                           style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                        <tr style="border-collapse:collapse">
                                                            <td align="left" style="font-size: 16px;padding:5px;Margin:0;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif">
                                                                @isset($certified)
                                                                <p style="font-size: 20px;">인증 코드 : {{$certified->key ?? '인증 오류, 재인증 진행해주세요.'}}</p>
                                                                    위의 {{ Str::of($certified->key)->length()}}자의 인증 코드를 복사하여, 사이트내 인증 코드에 입력해주세요.
                                                                @else
                                                                    인증 코드 오류가 있습니다, 사이트 새로고침 후 재 인증 부탁드립니다.
                                                                @endisset
                                                            </td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse">
