                    ...
                    <tr style="border-collapse:collapse">
                        <td align="center" style="padding:0;Margin:0">
                            <table class="es-header-body"
                                ...
                                <tr style="border-collapse:collapse">
                                    <td align="left" bgcolor="#C1A485"
                                        style="padding:25px;Margin:0;background-color:#C1A485">
                                                                    ...
                                                                    <span style="font-size:32px;line-height: 2.5rem">
                                                                        <strong>
                                                                            @isset($reservation->type)
                                                                                {{$reservation->type==='tour' ? '투어' : '입주'}} {{$type ?? '확정'}} 정보입니다.
                                                                            @endisset
                                                                        </strong>
                                                                    </span>
                                                                </p>
                                                                    ...
                                                                    <tr style="border-collapse:collapse">
                                                                        <td width="80%" style="padding:0;Margin:0">
                                                                            <h4 style="Margin:0;line-height:120%;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif">
                                                                                @isset($reservation->type)
                                                                                    {{$reservation->type==='tour' ? '투어' : '입주'}} {{$type ?? '확정'}} 정보
                                                                                @endisset
                                                                            </h4>
                                                                        </td>
                                                                    ...
                                                                    @if($reservation->type === 'month')
                                                                        <ul>
                                                                            <li style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;Margin-bottom:15px;color:#333333">
                                                                                ...
                                                                                <ul>
                                                                                    <li style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;Margin-bottom:15px;color:#333333">
                                                                                        <font style="vertical-align:inherit">{{$reservation->room->title ?? '정보없음'}} {{$reservation->room->nights ? '('.$reservation->room->nights.'박' : ''}}{{$reservation->room->nights ? ' '.$reservation->room->days.'일)' : ''}}</font>
                                                                                    </li>
                                                                                </ul>
                                                                            </li>
                                                                        </ul>
                                                                        <ul>
                                                                            <li style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;Margin-bottom:15px;color:#333333">
                                                                                <font style="vertical-align:inherit">룸 타입</font>
                                                                                <ul>
                                                                                    <li style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;Margin-bottom:15px;color:#333333">
                                                                                        <font style="vertical-align:inherit">
                                                                                            @if($reservation->confirmations->count()>=1)
                                                                                                ...
                                                                                                @if(isset($reservation->room_type_id))
                                                                                                    {{\App\HotelRoomType::find($reservation->room_type_id)->name}}
                                                                                                    @isset($reservation->room_type_upgrade_id) > <span style="font-weight: bold;">{{ \App\HotelRoomType::find($reservation->room_type_upgrade_id)->name}}(업그레이드 적용)</span> @endisset
                                                                                                @else
                                                                        ...
                                                                        @if(isset($reservation->confirmation->payment_id)
                                                                            && $reservation->confirmation->payment_id !==''
                                                                            && $reservation->confirmation->payment_id !==null
                                                                            && \App\Settlement::where('payment_id', '=', $reservation->confirmation->payment_id)->count()>=1)
                                                                        <ul>
                                                                            <li style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;Margin-bottom:15px;color:#333333">
                                                                                <font style="vertical-align:inherit">
                                                                                    @if($type ==='연장' || $type ==='변경')
                                                                                ...
                                                                                <ul>
                                                                                    <li style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;Margin-bottom:15px;color:#333333">
                                                                                        <font style="vertical-align:inherit">
                                                                                            {{ number_format(\App\Settlement::where('payment_id', '=', $reservation->confirmation->payment_id)->latest()->first()->calculate ?? 0) }}
                                                                                        </font>
                                                                                    </li>
                                                                                </ul>
                                                                            </li>
                                                                        ...
                                                                        @endif
                                                                        @if($type ==='연장' && $reservation->confirmation->add_days !== 0 && $reservation->confirmation->add_days !== null)
                                                                        <ul>
                                                                            <li style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;Margin-bottom:15px;color:#333333">
                                                                                <font style="vertical-align:inherit">총 연장(박)수</font>
                                                                                <ul>
                                                                                    <li style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;Margin-bottom:15px;color:#333333">
                                                                                        <font style="vertical-align:inherit">
                                                                                            +{{$reservation->confirmation->add_days.'박'}}
                                                                                        </font>
                                                                                    </li>
                                                                                </ul>
                                                                            </li>
                                        ...
                                        <table class="es-left" cellspacing="0" cellpadding="0" align="left"
                                            ...
                                            <tr style="border-collapse:collapse">
                                                <td class="es-m-p20b" align="left"
                                                    style="padding:0;padding-left:10px;Margin:0;width:214px">
                                                    <table width="100%" cellspacing="0" cellpadding="0"
                                                           role="presentation"
                                                           style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                        <tr style="border-collapse:collapse">
                                                        ...
                                                        <tr style="border-collapse:collapse">
                                                            <td align="left" style="padding:0;Margin:0;padding-bottom:15px">
                                                                <h4 style="Margin:0;line-height:120%;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif">
                                                                    <font style="vertical-align:inherit">고객 연락처</font>
                                                                </h4>
                                                            </td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse">
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0"
                                                        ...
                                                        <tr style="border-collapse:collapse">
                                                            <td align="left" style="padding:0;Margin:0;padding-bottom:15px">
                                                                <h4 style="Margin:0;line-height:120%;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif">
                                                                    @isset($reservation->type)
                                                                        {{ $reservation->type === 'tour' ? '투어' : '입주' }} {{$type ?? '확정'}}일
                                                                    @endisset
                                                                </h4>
                                                            </td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse">
                                                            <td align="left" style="padding:0;Margin:0;padding-bottom:15px">
                                                                <p style="font-size:18px;Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#333333">
                                                                    @if($reservation->confirmations->count()>=1 && $reservation->confirmation->start_dt !== null)
                                                        ...
                                                        <tr style="border-collapse:collapse">
                                                            <td align="left" style="padding:0;Margin:0;padding-bottom:15px">
                                                                <p style="font-size:18px;Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#333333">
                                                                    @if($reservation->confirmations->count()>=1 && $reservation->confirmation->end_dt !== null)
