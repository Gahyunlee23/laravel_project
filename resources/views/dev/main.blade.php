            ...
            <div class="w-full" style="padding: 0;">
                <div class="">
                    ...
                    <div class="space-y-10 sm:space-y-12 lg:space-y-16">
                        <div class="3xs:px-6 sm:px-4">
                            <div class="max-w-1200 mx-auto pl-6 pr-8 sm:pl-4 sm:pr-6">
                                <div
                                    class="main_img_back_border absolute -mt-3 border-2 border-solid sm:-mt-5 border-tm-c-C1A485 fade-up opacity-25 transition duration-700 ease-out"
                                    style="z-index: -200;">
                                </div>
                            ...
                            <div class="flex bottom-0 justify-center -mt-2 3xs:-mt-4 sm:-mt-4 md:-mt-7 lg:-mt-11 z-50">
                                <div
                                    class="z-30 fade-up opacity-0 transition-all duration-700 ease-out text-xl italic PTSerif 4xs:text-2xl xs:text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-tm-c-C1A485">
                                    Living in Hotel
                                </div>
                            </div>
                        </div>
                        <div>
                            <div class="max-w-1200 mx-auto px-4">
                                <div class="flex justify-center fade-up opacity-0 delay-500 transition-all duration-1000 ease-out">
                                    <div class="JeJuMyeongJo text-white text-center text-base sm:text-lg md:text-xl lg:text-xl leading-8 sm:leading-10">
                                        한 번쯤 상상해 본 적 있지 않나요?<br>
                                        멋진 호텔에서 살고 있는 나의 모습을.<br>
                                        <br>
                                        호텔에서의 삶으로<br>
                                        워라밸을 꿈꾸는 직장인에게는 새로운 주거 공간을,<br>
                                        여행을 사랑하는 여행자에게는 매일을 여행으로<br>
                                        만들 수 있습니다.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mx-auto max-w-1200 px-4">
                                <div>
                                    <div class="flex justify-center">
                                        <div class="w-px h-28 border-solid sm:h-40 border-px fade-up opacity-0 delay-500 transition-all duration-1000 ease-out"
                                             style="border-color: #979797;background-color: #d8d8d8;"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="max-w-1200 mx-auto px-4">
                                <div>
                                    <div class="flex justify-center w-full">
                                        <div id="vimeo_video_01" class="w-full h-full"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        {{-- 지역 상품 리스트 --}}
                        <div class="pt-10 pb-14 sm:pb-20">
                            <div class="max-w-1200 mx-auto px-4">
                        ...
                        {{-- 리뷰 --}}
                        <div class="py-20 sm:py-28 overflow-x-hidden" style="margin-top:-45px;z-index:-1;background-color: #d7d3cf;">
                            <div class="max-w-1200 mx-auto px-4 #pt-72 #relative">
                        ...
                        <div class="pt-16 pb-16 overflow-x-hidden" x-data="{ hotelTab : 'main' }">
                                ...
                                <div class="py-2">
                                    <div class="flex">
                                        <div class="px-2 py-1"
                                             @click="hotelTab='main'"
                                             :class="{
                                                'text-white font-bold' : hotelTab==='main',
                                                'text-tm-c-979b9f' : hotelTab!=='main',
                                             }"
                                        >
                                            기본
                                        </div>
                                        <div class="px-2 py-1"
                                             @click="hotelTab='curator'"
                                             :class="{
                                                'text-white font-bold' : hotelTab==='curator',
                                                'text-tm-c-979b9f' : hotelTab!=='curator',
                                             }"
                                        >
                                            큐레이터
                                        </div>
                                    </div>
                                    <div class="productTitle PtSerif italic text-4xl text-white">
                                        Product
                                    </div>
                                    <div class="pt-4 flex mx-auto" style="max-width: 1000px;">
                                        <div class="w-full" x-show="hotelTab==='main'" x-cloak>
                                            <x-hotels.product.lists :hotels="$hotels" tab="main"></x-hotels.product.lists>
                                        </div>
                                        <div class="w-full" x-show="hotelTab==='curator'" x-cloak>
                                            <x-hotels.product.lists :hotels="$hotels" tab="curator"></x-hotels.product.lists>
                                        </div>
                                    </div>
                                </div>
...
호텔 별 특별 혜택(조식 밀키트, F&B 할인, 룸 업그레이드, 무료 세탁 등)과 입주자들과의 네트워킹(프라이빗 파티, 운동 메이트, 독서/와인 모임 등) 기회를 제공합니다."></x-faq.base>
                    ...
                    {{-- Daily Life --}}
                    {{--                    <div class="py-16 overflow-x-hidden overflow-y-hidden h-full">--}}
                    ...
                    {{--                                        <x-hotel.lists curator_id="{{$curator->id}}"></x-hotel.lists>--}}
                    {{--                                    @else--}}
                    {{--                                        <x-hotel.lists></x-hotel.lists>--}}
                    {{--                                    @endif--}}
                    {{--                                </div>--}}
                    {{--                            </div>--}}
                    ...
                    {{-- footer --}}
                    <div class="pt-16 pb-6 bg-tm-c-ED">
                        <div class="max-w-1200 px-4 mx-auto">
        ...
        <div class="z-50 flex justify-center items-center h-screen">
            <div class="w-auto px-2 xs:w-auto xs:px-0">
                ...
                <div class="bg-black bg-opacity-20 rounded-b-sm">
                    <a href="{{route('admin.dev.hotel.view',['hotel'=>19])}}" onclick="GA_event('popup_redirect',[19]);">
                        <div class="py-6 text-left px-6"
                            ...
                            {{--                            <div class="PtSerif italic text-xl 3xs:text-2xl text-white">--}}
                            {{--                                <div class="flex justify-start items-center">--}}
                            {{--                                    <div class="">OPEN</div>--}}
                            {{--                                    <div class="w-10 h-px ml-2 bg-white"></div>--}}
                            {{--                                </div>--}}
                            {{--                            </div>--}}
    ...
    {{-- 문의하기 버튼--}}
    <div class="kakaoOnetoOne fixed mx-auto z-50 rounded-full mb-5 mr-5 sm:mb-20 sm:mr-20" style="bottom: 0;right:0;">
        <div>
            <img class="lozad relative w-14 sm:w-18 rounded-full cursor-pointer"
                 onclick="GA_event('카카오톡 문의하기',['카카오톡 1:1']);kakaoOnetoOne()"
                 style="box-shadow: 2px 2px 10px 0 rgba(34,35,36,.2);"
                 data-src="https://d2pyzcqibfhr70.cloudfront.net/resource/icons/btn-flaoting-ask.svg" alt="">
        </div>
    </div>
...
<script type="text/javascript">
    ...
    var player = new Vimeo.Player('vimeo_video_01', options);
    var playerStopCheck = true;
        ...
        mainBannerSwiper = new Swiper('.main-banner-swiper-container', {
            ...
            on: {
                ...
                slideChange: function () {
                    ...
                    // GA_event('product_slide_change',[productSwiper.previousIndex,productSwiper.realIndex]);
                }
            }
        });
    }
    const mainBannerSize = function ($time){
        ...
        setTimeout(function () {
            ...
            // $('.main-banner-swiper-container .main-banner-swiper-pagination').stop().css({
            //     'height': $('.main_img').height(),
            // });
