...
<script>
    ...
    kakaoPixel('7968131379699859784').pageView('호텔 매니저 가입 페이지');
    @endunlessrole
</script>
    <div class="mx-auto pt-6 sm:pt-12 select-none">

        <div class="max-w-1200 mx-auto px-4 pb-12 md:pb-16 space-y-6 md:space-y-16">
            <div>
                <div class="leading-relaxed">
                    <div class="flex pb-2">
                        <div class="cursor-pointer" onclick="location.href='{{ route('enter.hotel') }}'">
                    ...
                    <div class="JeJuMyeongJo text-white text-lg 2xs:text-2xl md:text-3xl">
                        <p>파트너사 입점 신청을 위해</p>
                        <p>호텔 매니저 가입 절차를 진행해주세요.</p>
                    </div>
                </div>
            </div>
        </div>

        <div class="max-w-1200 mx-auto px-4 pb-20">
            <div>
                <livewire:enter.hotel.manager-form></livewire:enter.hotel.manager-form>
            </div>
        </div>
