...
@section('top-style')
    <style type="text/css">
        ...
        .thumb-spacing { margin-right: 0.5rem }
            ...
            <div class="w-full" style="padding: 0;">
                <div class="">
                    <div class="">
                                        ...
                                        <div>
                                            <div class="relative">
                                                <a class="flex cursor-pointer"
                                                     onclick="allImagesSlider();GA_event('호텔_상세_사진더보기_클릭',['{{$hotel->id}}']);">
                                                    <div class="flex-1">
                                        ...
                                        <div class="space-y-6 sm:space-y-8">
                                            ...
                                            <div class="grid sm:grid-cols-2 md:grid-cols-3 gap-6 mx-auto md:mx-0 px-6 sm:px-0">
                                                @foreach ($hotel->room_types()->where('visible','=','1')->where('upgrade','!=','Y')->orderBy('order')->get() as $room_type)
                                                    <a class="w-full max-w-md text-center mx-auto cursor-pointer"
                                                         onclick="appendBody('{{Str::of($room_type->name)->replace(' 룸','')}}','{{$room_type->ImagesSlide}}')">
                                                        <div class="text-center rounded-sm shadow-lg">
                                                            <div class="relative">
                                                                ...
                                                                @if(isset($room_type->ImagesSlide) && $room_type->ImagesSlide->count() >= 1)
                                                                    <div class="relative flex justify-center">
                                                                        <img data-src="{{secure_asset('https://d2pyzcqibfhr70.cloudfront.net/'.$room_type->ImagesSlide->first()) }}" class="lozad w-full h-60 sm:h-52 md:h-56 lg:h-68" alt="Room Image">
                                                                    </div>
                                                                @endif
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="max-w-1200 mx-auto">
                                                <div class="py-2">
                                                    ...
                                                    <div class="hidden sm:flex justify-center pt-10">
                                                        <div class="pt-5 review-swiper-pagination space-x-4"></div>
                                                    </div>
                                            ...
                                            <div class="max-w-1200 mx-auto">
                                                <div class="py-2" @if($hotel->faqs->count() >= 1)x-data="{ type: 'faq' }"@else x-data="{ type: 'cancel' }"@endif>
                                                    ...
                                                    <div class="flex pt-6 pb-4 space-x-4">
                                                        ...
                                                        @endisset
                                                        @isset($hotel->info_notion)
                                                            <div class="JeJuMyeongJo text-xl text-tm-c-30373F cursor-pointer"
                                                                 :class="{ 'text-tm-c-0D5E49 border-b-4 border-solid border-tm-c-0D5E49' : type === 'used'}"
                                                                 @click="type='used'">
                                                                <div class="px-px py-2">이용 시 주의사항</div>
                                                            </div>
                                                        @endisset
                                                    </div>
                                                    ...
                                                    <div class="pt-4" x-show="type==='used'" x-cloak>
                                                            <div>
                                                                @isset($hotel->info_notion)
                                                                    <div class="AppSdGothicNeoR text-tm-c-30373F font-bold text-base">
                                                                        호텔에삶 이용설명서
                                                                    </div>
                                                                    <div class="mt-4">
                                                                    <a href="{{$hotel->info_notion}}" target="_blank" class="w-full">
                                                                        <div class="py-6 bg-tm-c-30373F rounded-sm" style="box-shadow: 2px 2px 20px 0 rgba(0, 0, 0, 0.3);">
                                                                            <div class="flex justify-center items-center space-x-2 AppSdGothicNeoR font-bold text-lg">
                                                                                <div class="text-tm-c-C1A485 hidden md:block">{{$hotel->option->title}}</div>
                                                                                <div class="text-white">호텔 이용설명서 보기</div>
                                                                                <div>
                                                                                    <svg width="9" height="15" xmlns="http://www.w3.org/2000/svg">
                                                                                        <path d="m.5 14.31 7-7-7-7" stroke="#FFF" stroke-width="2" fill="none" fill-rule="evenodd"/>
                                                                                    </svg>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                @if($hotel->UsePrecautions->where('type', '=', '연장')->last()
                                                                    || $hotel->UsePrecautions->where('type', '=', '퇴실')->last()
                                                                    || $hotel->UsePrecautions->where('type', '=', '기타 특이사항')->last())
                                                                <div class="mt-8 sm:mt-12">
                                                                    ...
                                                                    <div class="mt-4 w-full space-y-3">
                                                                        @if($hotel->UsePrecautions->where('type', '=', '연장')->last())
                                                                            <div class="px-2 py-1 bg-tm-c-ED rounded-sm" x-data="{ show : false }">
                                                                            <div class=" cursor-pointer" x-on:click="show=!show">
                                                                                <div class="flex items-center text-sm px-2 py-4" style="max-height: 56px;">
                                                                                    <div class="float-left flex">
                                                                                        <div class="AppSdGothicNeoR text-tm-c-30373F font-bold text-lg leading-snug">
                                                                                            연장 시 주의사항 	전문 보기
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="float-left ml-auto cursor-pointer">
                                                                                        <img class="w-8 h-8" x-show="!show" style="min-width: 28px;" src="https://d2pyzcqibfhr70.cloudfront.net/resource/icons/pc-ic-dropdown.png" alt="">
                                                                                        <img class="w-8 h-8" x-cloak x-show="show" style="min-width: 28px;" src="https://d2pyzcqibfhr70.cloudfront.net/resource/icons/pc-ic-dropup.png" alt="">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div x-cloak x-show="show"
                                                                                 ...
                                                                                 x-transition:leave-end="transform opacity-0 -translate-y-3">
                                                                                <div class="flex justify-center">
                                                                                    <div class="bg-tm-c-C1A485 h-px" style="width: calc( 100% - 14px );"></div>
                                                                                </div>
                                                                                <div>
                                                                                    <div class="text-sm py-6 px-2 pl-6" style="text-indent: -1rem;">
                                                                                        <span class="faq_answer_text AppSdGothicNeoR text-lg leading-relaxed">
                                                                                            {{$hotel->UsePrecautions->where('type', '=', '연장')->last()->content ?? ''}}
                                                                                        </span>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        @if($hotel->UsePrecautions->where('type', '=', '퇴실')->last())
                                                                            <div class="px-2 py-1 bg-tm-c-ED rounded-sm" x-data="{ show : false }">
                                                                            <div class=" cursor-pointer" x-on:click="show=!show">
                                                                                <div class="flex items-center text-sm px-2 py-4" style="max-height: 56px;">
                                                                                    <div class="float-left flex">
                                                                            ...
                                                                            <div x-cloak x-show="show"
                                                                                ...
                                                                                <div>
                                                                                    <div class="text-sm py-6 px-2 pl-6" style="text-indent: -1rem;">
                                                                                        <span class="faq_answer_text AppSdGothicNeoR text-lg leading-relaxed">
                                                                                            {{$hotel->UsePrecautions->where('type', '=', '퇴실')->last()->content ?? ''}}
                                                                                        </span>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        @if($hotel->UsePrecautions->where('type', '=', '기타')->last())
                                                                            <div class="px-2 py-1 bg-tm-c-ED rounded-sm" x-data="{ show : false }">
                                                                            <div class=" cursor-pointer" x-on:click="show=!show">
                                                                                <div class="flex items-center text-sm px-2 py-4" style="max-height: 56px;">
                                                                                    <div class="float-left flex">
                                                                            ...
                                                                            <div x-cloak x-show="show"
                                                                                ...
                                                                                <div>
                                                                                    <div class="text-sm py-6 px-2 pl-6" style="text-indent: -1rem;">
                                                                                        <span class="faq_answer_text AppSdGothicNeoR text-lg leading-relaxed">
                                                                                            {{$hotel->UsePrecautions->where('type', '=', '기타')->last()->content ?? ''}}
                                                                                        </span>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                ...
                                                                <div class="mt-8 sm:mt-12">
                                                                    ...
                                                                    <div class="mt-4 w-full">
                                                                        <div class="channelTalk-button py-5 bg-transparent border border-solid border-tm-c-30373F rounded-sm cursor-pointer">
                                                                            <div class="flex justify-center items-center space-x-2 AppSdGothicNeoR font-bold text-lg">
                                                                                <div class="text-tm-c-30373F">호텔에삶 고객센터 연결하기</div>
                                                                                <div>
                                                                                    <svg class="h-6 w-6 flex-no-shrink fill-current" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                                                                                        <path d="M11 0a1 1 0 0 1 1 1v6.5a1 1 0 0 1-1 1l-3.018-.001-3.75 2.957V8.5H1a1 1 0 0 1-1-1V1a1 1 0 0 1 1-1h10zM3 3.317c-.414 0-.75.33-.75.737s.336.737.75.737.75-.33.75-.737A.744.744 0 0 0 3 3.317zm3 0c-.414 0-.75.33-.75.737s.336.737.75.737.75-.33.75-.737A.744.744 0 0 0 6 3.317zm3 0c-.414 0-.75.33-.75.737s.336.737.75.737.75-.33.75-.737A.744.744 0 0 0 9 3.317z" fill="#30373F" fill-rule="evenodd"/>
                                                                                    </svg>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                    ...
                                    <div class="px-4 px-2">
                                        <div class="">
                                            @if(isset($curator) && $curator)
                                                <x-hotel.lists hotel_id="{{$hotel->id}}" curator_id="{{$curator->id}}"></x-hotel.lists>
                                            @else
                                                <x-hotel.lists hotel_id="{{$hotel->id}}" ></x-hotel.lists>
                                            @endif
                                        </div>
                                    </div>
                        ...
                        <div class="light-box w-full h-screen fixed bg-black backdrop-filter backdrop-blur bg-opacity-70 top-0 bottom-0 hidden z-50">
                            <div class="w-full h-full">
                                <div class="absolute top-0 right-0 mr-8 mt-8 close-button cursor-pointer" onclick="closeLightBox()">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
                                        <g fill="none" fill-rule="evenodd">
                                            <g stroke="#FFF">
                                                <g>
                                                    <path d="M7 24.949L25.949 6M7 6L25.949 24.949" transform="translate(-460.000000, -78.000000) translate(459.500000, 78.000000)"/>
                                                </g>
                                            </g>
                                        </g>
                                    </svg>
                                ...
                                <div class="flex flex-wrap h-screen content-center">
                                    <div class="w-full flex items-center justify-center pb-4">
                                        <div class="w-11/12 flex justify-between" style="max-width: 960px;">
                                            <div class="room-type-title text-white font-bold text-lg sm:text-2xl"></div>
                                            <div class="flex text-white text-lg sm:text-2xl">
                                                <div class="current-slide-index">1</div>
                                                <div class="px-2">/</div>
                                                <div class="room-type-count"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="w-full pb-20">
                                        <div class="flex items-center justify-center">
                                            <div class="w-full pb-2" style="max-width: 960px;">
                                                <div class="w-full flex items-center pb-2">
                                                    <div class="room-type-con w-full outline-none room-type room-type-slider">
{{--                                                        <button class="slick-prev slick-arrow" aria-label="Previous" type="button" style="">Previous</button>--}}
{{--                                                        <button class="slick-next slick-arrow" aria-label="Next" type="button" style="">Next</button>--}}
                                                    </div>
                                                </div>
                                                <div class="w-full">
                                                    <div class="room-type-con room-type-thumb space-x-1 room-type-thumb-slider"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="mt-10 sm:mt-12 lg:mt-16">
                                <div class="overflow-x-hidden overflow-y-hidden h-full">
                                    <div class="other_hotels_container max-w-1200 mx-auto px-4">
                                        ...
                                        <div class="">
                                            <div class="">
                                                <livewire:other-hotel-lists :curator_id="$curator->id ?? null" :hotel="$hotel"></livewire:other-hotel-lists>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="pb-26 px-2">
                            <livewire:enter.recommendation></livewire:enter.recommendation>
                        </div>
                    </div>
                </div>
            </div>
...
@section('bottom-script')
    ...
    <script type="text/javascript">
        {{-- slick slider is setting into each elements that have roomtype images and thumbnails --}}
        function showSlick() {
            {{-- roomt type slider init --}}
            $('.room-type-slider').slick({
                slidesToShow: 1,
                slidesToScroll: 1,
                asNavFor: '.room-type-thumb-slider',
                infinite: false
            });

            {{-- room type thumbs init --}}
            $('.room-type-thumb-slider').slick({
                slidesToShow: 5,
                slidesToScroll: 1,
                asNavFor: '.room-type-slider',
                infinite: false,
                arrows: false,
                focusOnSelect: true
            });

            {{-- changes the index of the current element when it changes. index starts from 0, so + 1 for user...
                 for design friendly, get the target element and make it highlight with its border --}}
            $('.room-type-slider').on('afterChange', function (event, slick, currentSlide) {
                let thumbs = document.querySelector('.room-type-thumb'),
                    targetThumb = thumbs.querySelector('.slick-current'),
                    targetIndex = targetThumb.dataset.slickIndex,
                    currentIndex = currentSlide;

                $('.thumb-spacing').removeClass('highlight');
                $('.current-slide-index').text(currentIndex + 1);
                if(currentIndex == targetIndex) {
                    targetThumb.classList.add('highlight')
                }
            })
        }
        {{-- this function below is actually firing when user click the element --}}
        {{-- have many actions inside, read this from scratches... so we got the top of definitions --}}
        function appendBody($roomName, $imgs){
            let imgs = JSON.parse($imgs),
                count = 11 - imgs.length,
                name = $roomName;
            {{-- preventing scrolling when the lightbox and slick slider pop up --}}
            $('body').addClass('scroll-disable');
            {{-- for loop(just under this) adding content, so we need to removing part and this is it --}}
            $('.room-type-con').html('');
            $('.room-type-title').html('');
            $('.room-type-count').html('');
            $('.current-slide-index').html('1');
            {{-- for the ux and ui, we need a light box behind of the slick slider  --}}
            $('.light-box').removeClass('hidden');
            {{-- some dynamic infos like the roomtype names and count --}}
            $('.room-type-title').append(name);
            $('.room-type-count').append(imgs.length);
            {{-- for the design optimization, dividing imgCon into inmgCon and imgThumb so I can divide thumb part and main slider --}}
            for(let i = 0; i < imgs.length; i ++) {
                let imgpath = imgs[i],
                    imgCon = `<div><img src="https://d2pyzcqibfhr70.cloudfront.net/`+ imgpath + `"></div>`,
                    imgThumbs = `<div class="thumb-spacing"><img src="https://d2pyzcqibfhr70.cloudfront.net/`+ imgpath + `"></div>`;
                $('.room-type-slider').append(imgCon);
                $('.room-type-thumb').append(imgThumbs);
            }
            {{-- for the thumb nails, we fill up the blank spaces for empty images (room type images will be 3 - 10)--}}
            for(let i = 0; i < count; i ++) {
                let con = document.createElement('div');
                con.className = 'remaintainer';
                con.innerHTML = '<div class="remaintainer-text">호텔에삶</div>';
                $('.room-type-thumb').append(con);
            }
            showSlick();
        }
        {{-- close the light box, also do unslick for the slick slider --}}
        function closeLightBox() {
            $('.light-box').addClass('hidden');
            $('body').removeClass('scroll-disable');

            if($('.room-type-con').hasClass('slick-initialized')) {
                $('.room-type-slider').slick('unslick');
                $('.room-type-thumb').slick('unslick');
            }
        }
